...
export default function ChatView({
  ...
  const quickPrompts = [
    {
      ...
      model: 'gemini-3.5-flash' as GeminiModelId,
      persona: 'local_guide',
    },
    {
  ...
  const currentModel = chat?.model || 'gemini-3.5-flash';
      ...
      >
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          <div className="relative inline-block text-xs">
            <select
              ...
              onChange={(e) =>
                onUpdateChatSettings({
                  ...
                  // If switching to pro or lite while grounding is active, revert grounding to none
                  groundingMode:
                    e.target.value !== 'gemini-3.5-flash' && currentGrounding !== 'none'
                      ? 'none'
                      : currentGrounding,
                })
              }
            ...
            >
              <option value="gemini-3.5-flash">gemini-3.5-flash (General &amp; Grounding)</option>
